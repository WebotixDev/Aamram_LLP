...
@php
$till_date = request('till_date') ?? date('Y-m-d');
            ...
            <div class="card">
                <div class="card-block row">
                    ...
                    <div class="batch-table">
                        ...
                        <div class="">
                            <div class="card-body">
                                      <form method="GET" id="detailsdate">
                                        <div class="row form-row">
                                            <div class="col-md-2">
                                                <label for="till_date">Till Date</label>
                                                <input type="date" name="till_date" id="till_date" class="form-control" value="{{ $till_date }}">
                                            </div>
                                            <div class="col-md-2">
