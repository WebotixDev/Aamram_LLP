...
<div class="container-fluid basic_table">
    <div class="page-title" style="padding:0px;">
        <div class="row">
            <div class="col-sm-6">
                <h4> Farm Delivery Challan
                        <a href="{{ route('admin.Farm_Delivery_challan.create') }}" class="btn btn-secondary">{{ __('Add') }}</a>
                   <a href="{{ route('admin.farm.stock.forreport') }}" class="btn btn-primary">{{ __('Farm Stock') }}</a>
