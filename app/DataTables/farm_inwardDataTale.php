...
class farm_inwardDataTale extends DataTable
{
    /**
    ...
    ->filterColumn('supplier_invoice', function ($query, $keyword) {
        ...
        $q->where('supplier', 'like', "%{$keyword}%")
         ...
         ->addColumn('details', function ($row) {
                ...
                ->editColumn('action', function ($row) {
                    ...
                    $printButton = '<a href="' . route('admin.FarminwardBill.print', ['id' => $row->id]) . '"
            ...
            ->addColumn('supplier_invoice', function ($row) {
                return $row->supplier . ' - ' . $row->Invoicenumber;
            })
    ...
    public function getColumns(): array
    {
        return [
          ...
          ['data' => 'supplier_invoice', 'title' => __('Supplier / Invoice No')],
